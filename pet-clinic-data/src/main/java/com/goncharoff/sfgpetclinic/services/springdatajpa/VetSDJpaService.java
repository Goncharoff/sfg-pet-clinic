...
import com.goncharoff.sfgpetclinic.repositories.VetRepository;
...
public class VetSDJpaService implements VetService {
    ...
    public Vet findById(Long id) {
        return vetRepository.findById(id).orElseThrow(() -> new RuntimeException("Can not find vet with id " + id));
    }
